...
describe('UI/overlays/BottomDialog', () => {
	it('Should show description if provided', () => {
		const { getByTestId } = render(<BottomDialog description={'description'} />);
	...
	it('Should show children if provided', () => {
		const { getByTestId } = render(<BottomDialog children={'children'} />);
	...
	it('Should not show children if also description is given', () => {
		const { queryAllByTestId } = render(<BottomDialog children={'children'} description="description" />);
	...
	it('Should show title if provided', () => {
		const { getByTestId } = render(<BottomDialog title={'title'} />);
	...
	it('Should call given onDismiss if dismiss is clicked', () => {
		...
		const { getByTestId } = render(<BottomDialog onDismiss={mockDismiss} />);
    ...
    it('Should apply visible class if visible is given:', () => {
        const { getByTestId } = render(<BottomDialog visible />);
    ...
    it('Should NOT visible class if visible is given to false:', () => {
        const { getByTestId } = render(<BottomDialog visible={false} />);
	...
	describe('confirm actions behavior', () => {
		it('Should show action-confirm button when confirm is given', () => {
			const { getByTestId } = render(<BottomDialog confirm={'confirm'} />);
		...
		it('Should NOT show action-confirm button when confirm is NOT given', () => {
			const { queryAllByTestId } = render(<BottomDialog />);
		...
		it('Should call on confirm when confirm is given and action-confirm is clicked', () => {
			...
			const { getByTestId } = render(<BottomDialog confirm={'confirm'} onConfirm={mockConfirm} />);
	...
	describe('secondary actions behavior', () => {
		it('Should show action-secondary button when secondary is given', () => {
			const { getByTestId } = render(<BottomDialog secondary={'secondary'} />);
		...
		it('Should call on secondary when confirm is given and action-secondary is clicked', () => {
			...
			const { getByTestId } = render(<BottomDialog secondary={'secondary'} onSecondary={mockSecondary} />);
