		...
		if (isButton) {
			return (
				<button
					...
					className={`${CSS.button} ${type} ${loadingClass} ${pressedClass} ${this.props.className || ''}`}
				>
					<em className={CSS.loadingWrapper}><MopIcon className={CSS.loadingIcon} />{this.props.loading}...</em>
