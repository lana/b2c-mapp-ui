...
const defaultExample: StoryFn<typeof Carousel> = (args, { argTypes }) => ({
...
const simpleExample: StoryFn<typeof Carousel> = (args) => ({
  setup() { return { ...args }; },
  components: {
    Carousel,
  },
...
const innerWidthItemExample: StoryFn<typeof Carousel> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    Carousel,
