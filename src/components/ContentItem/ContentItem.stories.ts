...
const defaultExample: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
...
const withImage: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
...
const withIcon: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
...
const successState: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
...
const withCustomForwardIcon: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
...
const noImageAndCustomForwardIcon: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
...
const customTitleAndCustomMetaText: StoryFn<typeof ContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ContentItem,
