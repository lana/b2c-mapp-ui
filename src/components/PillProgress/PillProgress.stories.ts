...
} as Meta<typeof PillProgress>;

const defaultExample: StoryFn<typeof PillProgress> = (args, { argTypes }) => ({
...
const withFlagsExample: StoryFn<typeof PillProgress> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    PillProgress,
