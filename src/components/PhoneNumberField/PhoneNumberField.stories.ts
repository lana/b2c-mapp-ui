...
const defaultExample: StoryFn<typeof PhoneNumberField> = (args, { argTypes }) => ({
...
const countryCodes: StoryFn<typeof PhoneNumberField> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    PhoneNumberField,
...
const moreExamples: StoryFn<typeof PhoneNumberField> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    PhoneNumberField,
