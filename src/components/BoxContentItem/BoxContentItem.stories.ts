...
} as Meta<typeof BoxContentItem>;

const defaultExample: StoryFn<typeof BoxContentItem> = (args, { argTypes }) => ({
...
const withImage: StoryFn<typeof BoxContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    BoxContentItem,
...
const withIcon: StoryFn<typeof BoxContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    BoxContentItem,
...
const successState: StoryFn<typeof BoxContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    BoxContentItem,
...
const listExample: StoryFn<typeof BoxContentItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    BoxContentItem,
