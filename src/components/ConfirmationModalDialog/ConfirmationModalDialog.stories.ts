...
} as Meta<typeof ConfirmationModalDialog>;

const defaultExample: StoryFn<typeof ConfirmationModalDialog> = (args, { argTypes }) => ({
...
const withCustomContent: StoryFn<typeof ConfirmationModalDialog> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ConfirmationModalDialog,
...
const withDismissButtonDisabled: StoryFn<typeof ConfirmationModalDialog> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ConfirmationModalDialog,
...
const withConfirmButtonDisabled: StoryFn<typeof ConfirmationModalDialog> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ConfirmationModalDialog,
...
const withCustomActionButton: StoryFn<typeof ConfirmationModalDialog> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    ConfirmationModalDialog,
