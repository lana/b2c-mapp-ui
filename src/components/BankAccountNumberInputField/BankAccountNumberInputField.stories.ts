...
} as Meta<typeof BankAccountNumberInputField>;

const defaultExample: StoryFn<typeof BankAccountNumberInputField> = (args, { argTypes }) => ({
...
const examples: StoryFn<typeof BankAccountNumberInputField> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    BankAccountNumberInputField,
