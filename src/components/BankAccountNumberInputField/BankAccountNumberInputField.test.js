...
describe('BankAccountNumberInputField unit test:', () => {
  ...
  it('Should apply the correct format when autoformat is enabled, for the given modelValue: ', () => new Promise((resolve) => {
  ...
  it('Should apply the correct format when autoformat is disabled, for the given modelValue: ', () => new Promise((resolve) => {
  ...
  it('Should take given input modelValue: ', () => new Promise((resolve) => {
