...
} as Meta<typeof CopyableListItem>;

const defaultExample: StoryFn<typeof CopyableListItem> = (args, { argTypes }) => ({
...
const moreExampleStates: StoryFn<typeof CopyableListItem> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    CopyableListItem,
