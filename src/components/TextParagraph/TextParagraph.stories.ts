...
const defaultExample: StoryFn<typeof TextParagraph> = (args, { argTypes }) => ({
...
const examples: StoryFn<typeof TextParagraph> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    TextParagraph,
...
const weights: StoryFn<typeof TextParagraph> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    TextParagraph,
...
const sizes: StoryFn<typeof TextParagraph> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    TextParagraph,
...
const colors: StoryFn<typeof TextParagraph> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    TextParagraph,
