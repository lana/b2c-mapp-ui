...
describe('SelectBox unit test', () => {
  ...
  it('Should select given selected option in options if theres no given value', () => {
    ...
    const firstOptionIsSelected = options[0].getAttribute('data-selected') === 'true';
    const secondOptionIsNotSelected = options[1].getAttribute('data-selected') === 'false';
  ...
  it('Should select option based on given value', () => {
    ...
    const firstOptionIsNotSelected = options[0].getAttribute('data-selected') === 'false';
    const secondOptionIsSelected = options[1].getAttribute('data-selected') === 'true';
  ...
  it('Should apply given value as selectedValue', async () => {
    ...
    const wrapper = mount(SelectBox, { props: { ...defaultProps, modelValue: givenValue } });
    await wrapper.vm.$nextTick();
