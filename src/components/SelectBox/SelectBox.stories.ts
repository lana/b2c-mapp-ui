...
const defaultExample: StoryFn<typeof SelectBox> = (args, { argTypes }) => ({
...
const withPreselectedValue: StoryFn<typeof SelectBox> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    SelectBox,
...
const withNoValueInitiallySelected: StoryFn<typeof SelectBox> = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  setup() { return { ...args }; },
  components: {
    SelectBox,
