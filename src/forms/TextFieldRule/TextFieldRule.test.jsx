...
import TextFieldRule from './TextFieldRule';

describe('UI/forms/TextFieldRule', () => {
    ...
    it('Should NOT be empty if given value is provided', () => {
        const { getByTestId } = render(<TextFieldRule {...defaultProps}/>);
        waitForDomChange(() => {
    ...
    it('Should NOT be empty if given value is provided', () => {
        const { getByTestId } = render(<TextFieldRule {...defaultProps} value={'Text value'}/>);
        waitForDomChange(() => {
    ...
    it('Should show error label if errorlabel is given', () => {
        const { getByTestId } = render(<TextFieldRule {...defaultProps} value={'Text value'} errorLabel={'error label'}/>);
    ...
    it('Should call given onBlur when text field is blurred', () => {
        ...
        const { getByTestId } = render(<TextFieldRule {...defaultProps} value={'Text value'} onBlur={mockBlur}/>);
    ...
    it('Should call given onChange when text field is changed', () => {
        ...
        const { getByTestId } = render(<TextFieldRule {...defaultProps} value={'Text value'} onChange={mockChange}/>);
        const input = getByTestId('text-field-rule-input');
        fireEvent.focus(input);
